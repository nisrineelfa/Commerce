<%-- 
    Document   : indexl
    Created on : 22 nov. 2022, 00:43:18
    Author     : admin
--%>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Home</a></li>
								<li><a href="cart.html"><i class="fa fa-shopping-cart"></i>About </a></li>
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
                            ...
                            <form method="post" action="LoginAdm"  class="register-form" id="login-form">
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="SIGNUP-form"><!--login form-->
						<h2>SIGNUP to your account</h2>
                                                <form method="post" action="SignupAdm"> 
